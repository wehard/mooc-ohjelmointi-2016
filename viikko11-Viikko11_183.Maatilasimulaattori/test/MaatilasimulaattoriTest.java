...
import maatilasimulaattori.Eleleva;
import maatilasimulaattori.Lypsava;
...
public class MaatilasimulaattoriTest<S, L, R, N, M> {
    ...
    private MethodRef1<N, Void, Collection> navettaHoidaLehmatMethodRef;
    ...
    private void reflektoiMaitosailio() {
        String luokanNimi = "maatilasimulaattori.Maitosailio";

        maitosailioClassRef = (ClassRef<S>) Reflex.reflect(luokanNimi);

        saniteettitarkastus("maatilasimulaattori.Maitosailio", 2, "kuin tilavuuden ja maitomäärän muistavat oliomuuuttujat");
    ...
    private void reflektoiLehma() {
        String luokanNimi = "maatilasimulaattori.Lehma";
    ...
    private void reflektoiLypsyrobotti() {
        String luokanNimi = "maatilasimulaattori.Lypsyrobotti";
    ...
    private void reflektoiNavetta() {
        String luokanNimi = "maatilasimulaattori.Navetta";
        ...
        Assert.assertTrue("Luokalla " + s(luokanNimi) + " ei ole metodia public void hoida(Collection<Lehma> lehmat)",
    ...
    private void reflektoiMaatila() {
        String luokanNimi = "maatilasimulaattori.Maatila";
