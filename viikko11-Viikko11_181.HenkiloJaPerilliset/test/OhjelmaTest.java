...
public class OhjelmaTest {
    ...
    String henkiloLuokanNimi = "henkilot.Henkilo";
    String opiskelijaLuokanNimi = "henkilot.Opiskelija";
    String opettajaLuokanNimi = "henkilot.Opettaja";
    ...
    @Test
    @Points("181.5")
    public void tulostaLaitoksenHenkilotMetodiluokallaMain() throws Throwable {
        String klassName = "Main";
        Reflex.ClassRef<Object> classRef;
        classRef = Reflex.reflect(klassName);
        String metodi = "tulostaLaitoksenHenkilot";

        String virhe = "tee Main-luokalle metodi public static void tulostaLaitoksenHenkilot(List<Henkilo> henkilot)";

        assertTrue(virhe,
                classRef.staticMethod(metodi).returningVoid().taking(List.class).isPublic());

        String v = "List<Henkilo> lista = new ArrayList<Henkilo>();\n"
                + "lista.add( new Opiskelija(\"Pekka\",\"Korso\") );\n"
                + "Main.tulostaLaitoksenHenkilot(lista)\n";
    ...
    @Test
    @Points("181.5")
    public void tulostaLaitoksenHenkilotToimii1() throws Exception, Throwable {
        ...
        String v = "Toimiiko metodi tulostaLaitoksenHenkilot oikein? \n"
    ...
    @Test
    @Points("181.5")
    public void tulostaLaitoksenHenkilotToimi2() throws Exception, Throwable {
        MockInOut io = new MockInOut("");
        List a = new ArrayList();
